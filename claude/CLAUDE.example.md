...
> Команд-нейтральная выжимка этих же правил — в [AGENTS.md](../AGENTS.md), ставится через
> `install.sh`. Секция «Role & Communication Style» ниже — **персональная**: роль описывается
